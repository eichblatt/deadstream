...
main:{[parms]
  ...
  setbreaks:0!`date`event_id`isong xasc select last song,last isong,last next_set by date,event_id,venue,city,state,show_set from jb where act like "Grateful*";
