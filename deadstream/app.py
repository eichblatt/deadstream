...
def save_tape_data_in_cloud(t, date, collection, i_tape):
    ...
    if len(trackdata_string) > 0:
        ...
        cloud_utils.write_json_in_cloud(trackdata, trackdata_blob_name)
...
def get_all_tapes(date):
    ...
    if len(t) == 0:
        ...
        cloud_utils.write_json_in_cloud(tids, tids_blob_name)
...
def vcs(collection):
    ...
    try:
        ...
        cloud_utils.write_json_in_cloud(vcs_data, vcs_blob_name)
    except:
        pass
    finally:
        pass
